...
[依赖检测]
    ...
    可选：
    - .codex/feedback/ 中的相关记录 → 如来自 EVOLUTION.md 提议，读取原始 feedback 了解需求背景
...
[工作流程]
    ...
    [第五步：创建文件]
        在 .codex/skills/[skill-name]/ 下创建 SKILL.md
    ...
    [第六步：注册到 AGENTS.md]
        Codex CLI 不自动发现 `.codex/skills/` 下的新 Skill。
        必须在 AGENTS.md 中补充：
